namespace eval pts {
	...
	proc getKeyFrames {filePath} {
		...
		set input [open "| $setting::ffprobePath -threads $numOfThreads -select_streams v -skip_frame nokey -show_frames -show_entries frame=pts_time -of csv=p=0 -v quiet $filePath" r]
