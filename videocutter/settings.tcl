namespace eval setting {
	namespace export player imageTool locale numOfProcessors initialDir logPath mplayerPath ffprobePath ffmpegPath fileTypes imageFormats videoFormats defaultVolume muteOnStart aspectRatios ratioWildcards ffmpegReport setFfmpegReport
	...
	variable mpvPath "/usr/bin/mpv"
	variable cwebpPath "/usr/bin/cwebp"
	...
	variable ratioWildcards [list [size::newSize * 400] [size::newSize * 480] [size::newSize * 540] [size::newSize * 720] [size::newSize 960 *]]
